...
% Solving options
name = 'hyperSensitive'; % name of the problem
...
% Bounds
lbx = -50; % lower bound for state
ubx = +50; % upper bound for state
lbu = -50; % lower bound for control
ubu = +50; % upper bound for control 
...
nx = 1; nu = 1; np = 0; % state, control, and parameter dimensions

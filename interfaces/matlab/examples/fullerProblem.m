%--------------------------- Fuller's Problem ----------------------------%
% This problem is taken from Section 8.5.3 of the following reference:    %
...
% Solving options
name = 'fullerProblem'; % name of the problem
...
l = 0.5*x(2)^2; % running (Lagrange) cost

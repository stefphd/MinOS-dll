...
% The problem has FREE final time t_f, therefore it is converted to a     %
% fixed final time problem by scaling the time by t_f. The domain becomes %
% [0, 1], and the dynamc constraint are expressed in the new domain by    %
% multiplying dx/dt by t_f. The final time t_f this becomes a free        %
...
% Solving options
name = 'brachistochroneBasic'; % name of the problem

...
% Solving options
name = 'brysonDenham'; % name of the problem
...
% Boundary conditions
xi = [0; +1]; % initial x1, x2
xf = [0; -1]; % final x1, x2

% Bounds
lbx = [0; -10]; % lower bound for state
ubx = [L; +10]; % upper bound for state
lbu = -10; % lower bound for control
ubu = 5; % upper bound for control
...
l = u(1)^2/2; % running (Lagrange) cost

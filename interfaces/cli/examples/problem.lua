-- LUA problem file for minos-cli
-- Usage
--   minos-cli -s problem.lua
...
-- problem definition
problem = {
    name = 'brachistochrone',      -- name of the problem
...
problem.bounds = {
	...
	lbu = { -math.pi / 2 },    -- lower bound for control
	ubu = {  math.pi / 2 },    -- upper bound for control
...
-- problem.options = {
	...
	-- logfile = 'nlp.log',      -- NLP log filename ('none' for no log file)

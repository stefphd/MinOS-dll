# Generate hyperSensitive problem
...
parser.add_argument('cfilename', type = str, nargs='?', default='hyperSensitive.c')
...
# Model equations
xdot = -x[0] + u[0] # state derivative
c = [] # path constraint
q = [] # integral constraint
l = 0.5*(x[0]**2 + u[0]**2) # running cost
m = 0 # boundary cost
